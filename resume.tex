%-------------------------------------------------------------------------------
% TEMPLATE: RusselResume from OverLeaf
%-------------------------------------------------------------------------------
...
\photo[rectangle,edge,right]{./thisisme.jpg} 
\name{Luca}{Dalmasso}
\position{Embedded Systems Engineer{\enskip\cdotp\enskip}}
%\address{YOUR ADDRESS}

\mobile{+39/ 3208686400}
\email{luca.dalmasso.97@outlook.it}
\dateofbirth{March 3rd, 1997}
%\homepage{www.posquit0.com} 
\github{github.com/Luca-Dalmasso}
\linkedin{https://www.linkedin.com/in/luca-dalmasso-997b70255}
% \gitlab{gitlab-id}
% \stackoverflow{SO-id}{SO-name}
% \twitter{@twit}
%\skype{live:.cid.347a488adb2cc538}
% \reddit{reddit-id}
% \medium{madium-id}
% \kaggle{kaggle-id}
...
\vspace*{\fill}
\centering{\textbf{Open to relocate.}}
%-------------------------------------------------------------------------------
\end{document}
